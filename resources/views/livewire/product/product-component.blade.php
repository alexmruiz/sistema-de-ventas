        ...
        <x-table>
            ...
            @forelse ($products as $product)
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="badge badge-secondary" href="{{route('categorias.show', $product->category->id)}}"> {{ $product->category->name }}
                        </td>
                        <td>{!! $product->activeLabel !!}</td>                          
                        <td>
                            <a href="{{route('product.show',$product)}}" class="btn btn-success bt-sm" title="Ver">
